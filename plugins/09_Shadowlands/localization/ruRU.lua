...
L["baedos_note"] = "Несите бочки с Ферментированными чистоплодами из окрестностей к {npc:161536}, пока он не активируется."
...
L["collector_astor_note"] = "Прочтите все шесть глав Наследия Милосерды, разбросанных по комнате, после чего вы получите сообщение от {npc:157979}. Поговорите с ней, чтобы получить {spell:333779}, позволяющее вам найти скрытый {item:180569} на северо-западе. Возврат главы породит редкое."
L["corrupted_clawguard_note"] = "Возьмите {item:180651} в Лагере Кузнецов вверх по холму и используйте его для ремонта {npc:171300}."
...
L["nikara_note"] = "С двумя другими игроками, нажмите на Древний ладан, чтобы вызвать."
